                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                sun = (sun == 'Sun') ? '1' : 'Sun';
                                if(sun== 'Sun'){_showModalSheetSlots(sun);}
                              });
                            },
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                ...
                                if(mon== 'Mon'){_showModalSheetSlots(mon);}
                              });
                            },
                            child: Container(
                                height: 20,
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                tue = (tue == 'Tue') ? '3' : 'Tue';
                                if(tue== 'Tue'){_showModalSheetSlots(tue);}
                              });
                            },
                            child: Container(
                                height: 20,
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                wed = (wed == 'Wed') ? '4' : 'Wed';
                                if(wed == 'Wed'){_showModalSheetSlots(wed);}
                              });
                            },
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                thu = (thu == 'Thu') ? '5' : 'Thu';
                                if(thu == 'Thu'){_showModalSheetSlots(thu);}
                              });
                            },
                            child: Container(
                                height: 20,
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                fri = (fri == 'Fri') ? '6' : 'Fri';
                                if(fri == 'Fri'){_showModalSheetSlots(fri);}
                              });
                            },
                            child: Container(
                                height: 20,
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                sat = (sat == 'Sat') ? '7' : 'Sat';
                                if(sat == 'Sat'){_showModalSheetSlots(sat);}
                              });
                            },
                            child: Container(
                                height: 20,
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: FlatButton(
                              ...
                              color:  morning ?  Colors.blue : Colors.white,
                              textColor: morning ?  Colors.white:Colors.grey,
                          ...
                          child: Container(
                            ...
                            child: FlatButton(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(3.0),
                                  side: BorderSide(color: Colors.grey)),
                              color:  afternoon ?  Colors.blue : Colors.white,
                              textColor: afternoon ?  Colors.white:Colors.grey,
                              padding: EdgeInsets.all(8.0),
                              onPressed: () {
                                setState(() {
                                  afternoon = !afternoon;
                          ...
                          child: Container(
                            ...
                            child: FlatButton(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(3.0),
                                  side: BorderSide(color: Colors.grey)),
                              color:  evening ?  Colors.blue : Colors.white,
                              textColor: evening ?  Colors.white:Colors.grey,
                              padding: EdgeInsets.all(8.0),
                              onPressed: () {setState(() {
                                evening = !evening;
                              });},
                        ...
                        Expanded(
                          ...
                          child: RangeSlider(
                              ...
                              onChanged: (value) {
                                setState(() {
                                  labels = RangeLabels(
                                      (values.start.toInt() == value.start.toInt()) ? "" : "${value.start.toInt().toString()}\$",
                                      (values.end.toInt() == value.end.toInt()) ? "" : "${value.end.toInt().toString()}\$");
                                });
                                values = value;
