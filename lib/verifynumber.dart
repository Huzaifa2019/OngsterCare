              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "Well use your number for account",
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "verificationa and security only.It will not",
                        style: TextStyle(fontSize: 17),
                      ),
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      Text(
                        "be visible on the ongstrecare site.",
                        style: TextStyle(fontSize: 17),
                      ),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "receiving text messages or call from",
                        style: TextStyle(fontSize: 17),
                      ),
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      Text(
                        "the ongstrecare app to verify your",
                        style: TextStyle(fontSize: 17),
                      ),
                    ],
                  ),
